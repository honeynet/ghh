...
//GHH Honeypot by GHH project for GHDB Signature #1122 (wwwboard WebAdmin  inurl:passwd.txt wwwboard|webadmin)
////////////////////////////////////////////////////////
$HoneypotName = "PASSWD.TXT"; //This name should be unique if reporting multiple honeypots to one file or database. Helps determine what honeypot made a log.

echo 'WebAdmin' . ':' . DumpPassword();
...
if (strstr($Attack['referer'], "wwwboard") || strstr($Attach['referer'], "passwd.txt"){
 $Signature[] = "Target in URL";
}

//Finds if exact GHDB signature was used
if (strstr ($Attack['referer'], "wwwboard+WebAdmin++inurl%3Apasswd.txt+wwwboard%7Cwebadmin")){
