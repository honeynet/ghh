...
Place webutil.pl in your document root

Create the "transparent link" as described in the user manual to webutil.pl.

Change the $ConfigFile variable to the path of your config file.

Change the $SafeReferer variable to the page with the transparent link to webutil.pl.
